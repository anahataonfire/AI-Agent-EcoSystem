...
POLYMARKET_CONFIG = {
    ...
    "target_tags": [
        "crypto", "crypto-prices", "recurring",
        "politics", "geopolitics", "world", "elections", "government",
        "finance", "stocks", "economics", "central-banks",
        "tech", "ai", "science",
        "sports", "entertainment", "culture",
        "weather", "legal",
    ],
    
    # Set to True to scan ALL active markets
